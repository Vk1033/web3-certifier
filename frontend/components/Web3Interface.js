        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-sm text-gray-600">Blockchain-based certificate verification - Powered by Next.js</p>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center stats-card">
              <div className="text-3xl font-bold text-blue-600 stats-number">{stats.total}</div>
              <div className="text-gray-600 stats-label">Total Certificates</div>
            </div>
            <div className="text-center stats-card">
              <div className="text-3xl font-bold text-green-600 stats-number">{isOwner ? '1' : '0'}</div>
              <div className="text-gray-600 stats-label">Super Admin</div>
            </div>
            <div className="text-center stats-card">
              <div className="text-3xl font-bold text-purple-600 stats-number">{isOrganization ? '✓' : '✗'}</div>
              <div className="text-gray-600 stats-label">Organization Status</div>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="border-b border-gray-200">
            <nav className="flex space-x-8 px-6">
              <button
                ...
                className={`py-4 px-2 border-b-2 font-medium text-sm tab-button ${
                  activeTab === 'verify' ? 'active border-blue-500 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-700'
                }`}
              >
                🔍 Verify Certificate
              </button>
              ...
              {isOrganization && (
                <button
                  ...
                  className={`py-4 px-2 border-b-2 font-medium text-sm tab-button ${
                    activeTab === 'issue' ? 'active border-blue-500 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-700'
                  }`}
                >
                  📝 Issue Certificate
                </button>
              ...
              {isOwner && (
                <button
                  ...
                  className={`py-4 px-2 border-b-2 font-medium text-sm tab-button ${
                    activeTab === 'admin' ? 'active border-blue-500 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-700'
                  }`}
                >
                  ⚙️ Admin Panel
                </button>
              ...
              <button
                ...
                className={`py-4 px-2 border-b-2 font-medium text-sm tab-button ${
                  activeTab === 'search' ? 'active border-blue-500 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-700'
                }`}
              >
                🔎 Search Certificates
              </button>
          ...
          <div className="p-6">
            ...
            {activeTab === 'verify' && (
              <div className="space-y-6">
                <div>
                  ...
                  <div className="flex space-x-4">
                    <input
                      ...
                      className="flex-1 px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 form-input"
                    />
                    <button
                      onClick={verifyCertificate}
                      disabled={loading}
                      className="bg-blue-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed btn-hover-scale"
                    >
                      {loading ? (
                ...
                {/* Verification Result */}
                {verificationResult && (
                  <div className={`rounded-xl p-6 verification-result ${verificationResult.valid ? 'valid bg-green-50 border border-green-200' : 'invalid bg-red-50 border border-red-200'}`}>
                      ...
                      <div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                          ...
                          <div>
                            ...
                            <p className="font-mono text-xs bg-gray-100 px-2 py-1 rounded eth-address">{formatAddress(verificationResult.organization)}</p>
                          </div>
                        </div>
                      </div>
                    ) : (
            ...
            {activeTab === 'issue' && isOrganization && (
              <div className="space-y-6">
                <div>
                  ...
                  <div className="form-group">
                    <label className="form-label">Course/Certification</label>
                    <input
                      type="text"
                  ...
                  <button
                    ...
                    disabled={loading}
                    className="w-full bg-green-600 text-white py-3 px-6 rounded-lg font-semibold hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed btn-hover-scale"
                  >
                    {loading ? (
                ...
                <div>
                  ...
                  <div className="flex space-x-4">
                    ...
                    <button
                      ...
                      disabled={loading}
                      className="bg-purple-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-purple-700 disabled:opacity-50 disabled:cursor-not-allowed btn-hover-scale"
                    >
                      {loading ? (
                        <div className="flex items-center">
                          <div className="spinner mr-2"></div>
                ...
                <div>
                  ...
                  <div className="flex space-x-4">
                    ...
                    <button
                      ...
                      disabled={loading}
                      className="bg-indigo-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-indigo-700 disabled:opacity-50 disabled:cursor-not-allowed btn-hover-scale"
                    >
                      {loading ? (
                        <div className="flex items-center">
                          <div className="spinner mr-2"></div>
                  ...
                  <div>
                    ...
                    <div className="grid gap-4">
                      {certificates.map((cert, index) => (
                        <div key={index} className="bg-gray-50 rounded-lg p-4 border hover-lift">
      ...
      <footer className="bg-white border-t mt-12">
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="text-center text-gray-600">
            <p>🔗 Web3 Certificate Registry - Powered by Next.js & Blockchain Technology</p>
            <p className="text-sm mt-2">Contract Address: <span className="font-mono bg-gray-100 px-2 py-1 rounded eth-address">{CONTRACT_ADDRESS}</span></p>
          </div>
        </div>
      </footer>
    </div>
